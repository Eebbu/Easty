...
public class PostexchangeUITest {
    @Rule
    public ActivityScenarioRule<Post_exchange> activityScenarioRule = new ActivityScenarioRule<>(Post_exchange.class);
    ...
    public void testElementsVisibility() {
        ...
        onView(withId(R.id.want_editText)).perform(scrollTo()).check(matches(isDisplayed()));
